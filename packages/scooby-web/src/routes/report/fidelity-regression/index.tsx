...
import { FidelityRegressionReport } from "./FidelityRegressionReport";
...
export function FidelityRegressionReportController({ report, review }: Props) {
...
function findFirstId(report: HostedFidelityRegressionReport): string {
